...
class MagneticResonanceImaging extends StatefulWidget {
  const MagneticResonanceImaging({super.key});

  @override
  State<MagneticResonanceImaging> createState() =>
      _MagneticResonanceImagingState();
}

class _MagneticResonanceImagingState extends State<MagneticResonanceImaging> {
  @override
    ...
    return Scaffold(
        ...
        body: Padding(
            ...
            child: MagneticImagingWidget(
              ...
              doctor: 'Dr / Omar',
              date: 'Date : 2/2/2025',
              buttonText: 'Request a consultation'.tr(),
              onButtonPressed: () {
                      showDialog(
                          context: context,
